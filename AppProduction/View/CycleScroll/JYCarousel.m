...
//            UIView * titleLableBottomView = [[UIView alloc] initWithFrame:CGRectMake(0, VIEW_WIDTH*0.6-50*BILI, VIEW_WIDTH, 50*BILI)];
//            titleLableBottomView.alpha = 0.7;
//            titleLableBottomView.backgroundColor = [UIColor blackColor];
//            [_scrollView addSubview:titleLableBottomView];
//
//            UILabel * lubBoTitleLable = [[UILabel alloc] initWithFrame:CGRectMake(0, VIEW_WIDTH*0.6-50*BILI, VIEW_WIDTH, 50*BILI)];
//            lubBoTitleLable.textAlignment = NSTextAlignmentCenter;
//            lubBoTitleLable.font = [UIFont systemFontOfSize:15*BILI];
//            lubBoTitleLable.textAlignment = NSTextAlignmentCenter;
//            lubBoTitleLable.textColor = [UIColor whiteColor];
//            lubBoTitleLable.text = [info objectForKey:@"title"];
//            [_scrollView addSubview:lubBoTitleLable];
        }
    }
}
...
- (void)changeImageIndex{
    ...
    [self.delegate sliderImageIndex:self.imageIndex];
}
