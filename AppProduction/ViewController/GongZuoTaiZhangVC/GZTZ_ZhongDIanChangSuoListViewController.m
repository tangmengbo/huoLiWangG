//
//  GZTZ_ZhongDIanChangSuoListViewController.m
//  SeeYou
//
...
#import "GZTZ_ZhongDIanChangSuoListViewController.h"

@interface GZTZ_ZhongDIanChangSuoListViewController ()

@end

@implementation GZTZ_ZhongDIanChangSuoListViewController
...
- (void)viewDidLoad {
    ...
    self.titleLale.text = @"重点场所巡查台账";
    //[self.searchBar setPlaceholder:@"请输入场所名称查询"];// 搜索框的占位符
    self.searchBar.delegate = self;
    [self.searchBar changeLeftPlaceholder:@"请输入场所名称查询"];
    [self showNewLoadingView:nil view:self.view];
    [self.cloudClient zhongDianChangSuoXunChaList:@"patrolVisits!patrolList.do"
                                  pagesize:@"20"
                                    pageno:@"1"
