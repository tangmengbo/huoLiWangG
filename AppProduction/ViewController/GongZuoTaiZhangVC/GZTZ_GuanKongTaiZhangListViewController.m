//
//  GZTZ_GuanKongTaiZhangListViewController.m
//  SeeYou
//
...
#import "GZTZ_GuanKongTaiZhangListViewController.h"

@interface GZTZ_GuanKongTaiZhangListViewController ()

@end

@implementation GZTZ_GuanKongTaiZhangListViewController
...
- (void)viewDidLoad {
    ...
    self.titleLale.text = @"管控台账";
    //[self.searchBar setPlaceholder:@"请输入重点人员姓名查询"];// 搜索框的占位符
    self.searchBar.delegate = self;
    [self.searchBar changeLeftPlaceholder:@"请输入重点人员姓名查询"];
    [self showNewLoadingView:nil view:self.view];
    [self.cloudClient zhongDianRenYuanZouFangMesList:@"patrolVisits!visitsList.do"
                               pagesize:@"20"
                                 pageno:@"1"
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section==0) {
        ...
        GuanKongTaiZhangListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:tableIdentifier];
        if (cell == nil)
        {
            cell = [[GuanKongTaiZhangListTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:tableIdentifier];
        }
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    GuanKongTaiZhangDetailViewController * vc = [[GuanKongTaiZhangDetailViewController alloc] init];
    vc.visitid = [info objectForKey:@"visitid"];
