//
//  GuanKongTaiZhangListTableViewCell.m
//  SeeYou
//
...
#import "GuanKongTaiZhangListTableViewCell.h"

@implementation GuanKongTaiZhangListTableViewCell
...
-(void)initData:(NSDictionary *)info
{
    ...
    titleLable.text = [info objectForKey:@"foucusname"];
    telLable.text = [info objectForKey:@"visitdate"];
}
