//
//  GZTZ_ChuZhiTaiZhangListViewController.m
//  SeeYou
//
...
#import "GZTZ_ChuZhiTaiZhangListViewController.h"

@interface GZTZ_ChuZhiTaiZhangListViewController ()

@end

@implementation GZTZ_ChuZhiTaiZhangListViewController
...
- (void)viewDidLoad {
    ...
    self.titleLale.text = @"处置台账";
    //[self.searchBar setPlaceholder:@"请输入事件名称查询"];// 搜索框的占位符
    
    self.searchBar.delegate = self;
    [self.searchBar changeLeftPlaceholder:@"请输入事件名称查询"];
    [self showNewLoadingView:nil view:self.view];
