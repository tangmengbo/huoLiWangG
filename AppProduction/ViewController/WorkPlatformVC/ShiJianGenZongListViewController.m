...
//
//  ShiJianGenZongListViewController.m
//  SeeYou
//
...
#import "ShiJianGenZongListViewController.h"

@interface ShiJianGenZongListViewController ()

@end

@implementation ShiJianGenZongListViewController
...
- (void)viewDidLoad {
    ...
    [self.cloudClient shiJianGenZongList:@"eventInfo.do"
                                pagesize:@"10"
                                  pageno:@"1"
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section==0) {
        ...
        ShiJianListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:tableIdentifier];
        if (cell == nil)
        {
            cell = [[ShiJianListTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:tableIdentifier];
        }
