//
//  ZhongDianChangSuoListViewController.m
//  SeeYou
//
...
#import "ZhongDianChangSuoListViewController.h"

@interface ZhongDianChangSuoListViewController ()

@end

@implementation ZhongDianChangSuoListViewController
...
- (void)viewDidLoad {
    ...
    self.titleLale.text = @"重点场所查询";
    //[self.searchBar setPlaceholder:@"请输重点场所查询名称查询"];// 搜索框的占位符
    self.searchBar.delegate = self;
    [self.searchBar changeLeftPlaceholder:@"请输重点场所查询名称查询"];
    [self showNewLoadingView:nil view:self.view];
    [self.cloudClient zhongDianChangSuoList:@"patrolVisits!foucusPlaceList.do"
                                   pagesize:@"20"
                                     pageno:@"1"
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section==0) {
        ...
        ZhongDianChangSuoListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:tableIdentifier];
        if (cell == nil)
        {
            cell = [[ZhongDianChangSuoListTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:tableIdentifier];
        }
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ZhongDianChangSuoMesViewController * vc = [[ZhongDianChangSuoMesViewController alloc] init];
