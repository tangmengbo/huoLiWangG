...
#import "HuZhuMessageListViewController.h"

@interface HuZhuMessageListViewController ()

@end

@implementation HuZhuMessageListViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    JiaTingXinXiViewController * vc = [[JiaTingXinXiViewController alloc] init];
    vc.holderid = [info objectForKey:@"holderid"];
