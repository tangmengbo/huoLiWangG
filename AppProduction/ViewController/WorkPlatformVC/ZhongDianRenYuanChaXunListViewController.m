//
//  ZhongDianRenYuanListViewController.m
//  SeeYou
//
...
#import "ZhongDianRenYuanChaXunListViewController.h"

@interface ZhongDianRenYuanChaXunListViewController ()

@end

@implementation ZhongDianRenYuanChaXunListViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section==0) {
        ...
        ZhongDianRenYuanChaXunListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:tableIdentifier];
        if (cell == nil)
        {
            cell = [[ZhongDianRenYuanChaXunListTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:tableIdentifier];
        }
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    NSDictionary * info = [self.sourceArray objectAtIndex:indexPath.row];
        ...
        ZhongDianRenQunXinXiViewController * vc = [[ZhongDianRenQunXinXiViewController alloc] init];
