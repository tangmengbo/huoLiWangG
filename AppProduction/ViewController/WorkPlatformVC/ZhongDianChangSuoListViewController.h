//
//  ZhongDianChangSuoListViewController.h
//  SeeYou
//
...
@interface ZhongDianChangSuoListViewController : BaseViewController<UITableViewDataSource,UITableViewDelegate,UISearchBarDelegate>
{
